...
class AddProdect():
        ...
        # webdriver.FirefoxProfile("C:\\Users\\Administrator\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\mhoh9ya8.test")
        # self.driver=webdriver.Firefox(firefox_profile=webdriver.FirefoxProfile("C:\\Users\\Administrator\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\6niwsxl2.default"))
    ...
    def testAddProdect(self):
        ...
        br.find_element_by_id("infoTitle").send_keys(tit.decode("utf-8"))#产品标题
